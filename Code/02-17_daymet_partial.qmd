...
read.csv :  makes a dataframe.
read_csv : makes a tibble (table). It looks better when printing.
...
geom_density only requires the x-axis.
...
Data for daily level and we have seven weather variables. So 365*7 = 2555
...
We cannot export the nested dataset to .csv or other data format. So we need to unnest it. 
